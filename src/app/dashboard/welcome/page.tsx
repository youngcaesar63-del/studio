      ...
      <g transform="translate(0, -20)">
          ...
          <g transform="translate(200, 110)">
              ...
              <g transform="rotate(45) translate(-10, -30)">
                  <path d="M0 -35 L4 0 L-4 0 Z" fill="#ef4444"/>
                  <rect x="-8" y="0" width="16" height="5" fill="#b91c1c" />
              </g>
               {/* Key */}
              <g transform="rotate(-45) translate(10, -30)">
                  <rect x="-3" y="-30" width="6" height="25" fill="#facc15" rx="2"/>
                  <rect x="-10" y="-35" width="20" height="8" fill="#facc15" rx="2"/>
                  <circle cx="0" cy="-31" r="3" stroke="#d97706" strokeWidth="1" fill="none"/>
              </g>
          </g>

...
const initialPersonnelData = [
    ...
    { id: 4, cardId: '30107150201237', name: 'محمود سعيد عبدالله', rank: 'عقيد', specialization: 'ركن', academicQualification: 'دكتوراه', batch: 'الدفعة 50', administration: 'الإدارة العامة للمعلومات الاستراتيجية', status: 'عمليات', statusDetail: 'الحدود الشرقية', appointmentDate: new Date().toISOString(), certificateType: 'مستديمة', bloodType: 'AB+', maritalStatus: 'متزوج', religion: 'مسلم', importantJobs: [], serviceOperations: [], trainingCourses: [], serviceHistory: [], medals: [], languages: [], fatherName: '', fatherAddress: '', motherName: '', wifeName: '', children: [], brothers: [], sisters: [] },
    { id: 5, cardId: '30208150201238', name: 'يوسف إبراهيم أحمد', rank: 'لواء', specialization: 'لا يوجد', academicQualification: 'بكالوريوس', batch: 'الدفعة 45', administration: 'رئاسة الهيئة', status: 'إلحاق', statusDetail: 'قيادة الأركان المشتركة', appointmentDate: new Date().toISOString(), certificateType: 'مستديمة', bloodType: 'A-', maritalStatus: 'متزوج', religion: 'مسلم', importantJobs: [], serviceOperations: [], trainingCourses: [], serviceHistory: [], medals: [], languages: [], fatherName: '', fatherAddress: '', motherName: '', wifeName: '', children: [], brothers: [], sisters: [] },

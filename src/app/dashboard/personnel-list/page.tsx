...
].map(p => ({ ...p, major: p.major || '', importantJobs: p.importantJobs || [], serviceOperations: p.serviceOperations || [], decisiveStorm: p.decisiveStorm || [], trainingCourses: p.trainingCourses || [], serviceHistory: p.serviceHistory || [], medals: p.medals || [], languages: p.languages || [], children: p.children || [], brothers: p.sisters || [], sisters: p.sisters || [], vehicles: [], phoneNumbers: p.phoneNumbers || {} }));

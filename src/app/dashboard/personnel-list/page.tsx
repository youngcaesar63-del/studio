...
].map(p => ({ ...p, importantJobs: p.importantJobs || [], serviceOperations: p.serviceOperations || [], decisiveStorm: p.decisiveStorm || [], trainingCourses: p.trainingCourses || [], serviceHistory: p.serviceHistory || [], medals: p.medals || [], languages: p.languages || [], children: p.children || [], brothers: p.brothers || [], sisters: p.sisters || [], vehicles: [], phoneNumbers: p.phoneNumbers || {} }));
